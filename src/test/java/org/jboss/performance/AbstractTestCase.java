...
public abstract class AbstractTestCase {
    ...
    protected ModelControllerClient unauthenticatedClient;
    ...
    protected class MonitorSubsystem implements Monitor {
    ...
    protected class DatasourcesSubsystem extends Subsystem {
